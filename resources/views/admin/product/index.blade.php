    ...
    <div class="col-lg-12 grid-margin stretch-card">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <x-flash-message />
                <a href="{{ route('trader.product.create') }}"><button
                        class="btn btn-outline-success btn-fw">{{ __('Add Product') }}</button></a> </p>
                        ...
                        <tbody>
                            @forelse ($products as $product)
                                <tr>
                                    ...
                                    <td><a href="{{ route('trader.product.edit', $product->id) }}"><button
                                                class="btn btn-outline-success btn-fw">{{ __('Edit') }}</button></a>
                                    </td>
                                    <td>
                                        <form action="{{ route('trader.product.destroy', $product->id) }}" method="post">
                                            @csrf
                                            @method('delete')
