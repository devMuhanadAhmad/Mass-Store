            ...
            <div class="col-lg-3 col-12">
                ...
                <div class="product-sidebar">
                    ...
                    <div class="single-widget search">
                        ...
                        <form action="#">
                            <input type="text" wire:model="name" placeholder="Search name product ...">
                    ...
                    <div class="single-widget condition">
                        ...
                        <div class="form-check">
                            <input name="price" class="form-check-input" type="checkbox" value="1" id="flexCheckDefault1">
                            <label class="form-check-label" for="flexCheckDefault1">
                                $50 - $100L (208)
                            </label>
                        </div>
                        <div class="form-check">
                            <input name="price" class="form-check-input" type="checkbox" value="2" id="flexCheckDefault2">
